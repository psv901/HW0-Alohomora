...
def SetupAll(BasePath, CheckPointPath):
    ...
    LabelsPathTrain = '/Users/psv/Downloads/YourDirectoryID_hw0/Phase2/Code/TxtFiles/LabelsTrain.txt'
...
def SetupDirNames(BasePath): 
    ...
    """
    DirNamesTrain = ReadDirNames('/Users/psv/Downloads/YourDirectoryID_hw0/Phase2/Code/TxtFiles/DirNamesTrain.txt')        
